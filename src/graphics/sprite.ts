...
export class Sprite {
    ...
    constructor(private imageFile: string, private pack: ResourcePack = <ResourcePack><unknown>undefined) {}
    ...
    loadFromFile(imageFile: string, pack: ResourcePack = <ResourcePack><unknown>undefined):RCode { return RCode.FAIL; }

    setSampleMode(mode: SpriteMode = SpriteMode.NORMAL): void {}
